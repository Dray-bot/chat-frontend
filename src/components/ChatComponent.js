...
export default function ChatComponent() {
  ...
  useEffect(() => {
    ...
    socketRef.current = io(process.env.NEXT_PUBLIC_SOCKET_URL || "https://chat-backend-s009.onrender.com/", {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-b from-white via-purple-50 to-white">
      ...
      <aside
        ...
        fixed sm:relative h-full sm:h-auto top-0 left-0
        ${sidebarOpen ? "w-64" : "w-0 sm:w-64"} overflow-hidden`}
      >
